...
<title>Bug Tracking | View Task User</title>
...
<div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> View Task User  </h3>
...
TaskUserId :  <%=taskUserBean.getTaskUserId() %><br><br>

UserId :  <%=taskUserBean.getUserId() %><br><br>

TaskId :  <%=taskUserBean.getTaskId() %><br><br>

Assign Status :  <%=taskUserBean.getAssignStatus() %><br><br>

StatusId :  <%=taskUserBean.getStatusId() %><br><br>

Utilized Hours :  <%=taskUserBean.getUtilizedHours() %><br><br>
