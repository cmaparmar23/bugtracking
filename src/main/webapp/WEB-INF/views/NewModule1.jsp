...
<title>Bug Tracking | New Module</title>
...
%>
                 ...
                 <form class="forms-sample" action="savemodule1" method="post" >
                 ...
                 <div class="input-group-prepend">
                  <div class="col-sm-9">
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2">Save Module</button>
