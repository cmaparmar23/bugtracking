...
<div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Edit Project User  </h3>
...
%>
                 ...
                 <form class="forms-sample"   action="updateprojectuser" method="post">
                 <input type="hidden" name="projectUserId" value="${projectUserBean.projectUserId }"/> 
      ...
      <%=ub.getUserId()==projectUserBean.getUserId() ?"selected" : "" %>>
       <%=ub.getFirstName()%> 
                  ...
                  <div class="col-sm-9">
                          <select class="btn btn-sm btn-outline-primary dropdown-toggle" name ="ProjectId"  data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								%>		
      								...
      								<%=pb.getProjectId()==projectUserBean.getProjectId()? "selected" : "" %>>
                      ...
                      <button type="submit" class="btn btn-gradient-primary me-2">Update Project USer</button>
                      <button class="btn btn-gradient-primary me-2" href="listprojectuser">Cancel</button>
