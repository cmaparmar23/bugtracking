...
User Id:  <%=userBean.getUserId()%><br><br>
First Name:  <%=userBean.getFirstName() %><br><br>
Last Name:   <%=userBean.getLastName()%><br><br>
Email:	<%=userBean.getEmail()%><br><br>
Password:	<%=userBean.getPassword()%><br><br>
Gender:		<%=userBean.getGender()%><br><br>
Contact Number:		 <%=userBean.getNumber()%><br><br>
Role:		<%=userBean.getRole()%><br><br>
Image:		<%=userBean.getImageUrl()%><br><br>
